...
local Window = Library.CreateLib("Roblox Hub", "BloodTheme")
...
-- CREDIT
local CreditSection = Main:NewSection("Script made by DaEript")


MainSection:NewButton("InfiniteYield", "You can use this in all game!", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

MainSection:NewButton("Esp", "You can see everyone place with this...", function()
    -- Unnamed ESP
...
MainSection:NewButton("Eclipse Hub", "This script only support some game.", function()
    getgenv().mainKey = "nil"

    local a,b,c,d,e=loadstring,request or http_request or (http and http.request) or (syn and syn.request),assert,tostring,"https://api.eclipsehub.xyz/auth"c(a and b,"Executor not Supported")a(b({Url=e.."\?\107e\121\61"..d(mainKey),Headers={["User-Agent"]="Eclipse"}}).Body)()
end)

MainSection:NewButton("Owl Hub", "Only support some game too.", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))();
end)

MainSection:NewButton("Proxima Hub", "Only support some game too.", function()
